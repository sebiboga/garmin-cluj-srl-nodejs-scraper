...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "Garmin") |
| group        | string   | Parent company group (e.g. "Garmin") |
...
- **scraperFile**: Full URL to GitHub raw workflow YML (e.g. `https://raw.githubusercontent.com/sebiboga/garmin-cluj-srl-nodejs-scraper/master/.github/workflows/scrape.yml`)
